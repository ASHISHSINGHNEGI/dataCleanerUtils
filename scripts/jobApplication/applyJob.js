...
import { createAdditionalDocuments, createMandatoryQuestions, writeFailureMessage, writeSuccessMessage } from "./helpers.js";
...
export const applyJob = async ({ job, user }) => {
    try {
        ...
        const applicationData = {
            ...
            jobId: job._id,
            jobSnapshot: job,
            additionalDocuments: createAdditionalDocuments(
                job.requiredDocuments,
                {}),
            mandatoryQuestions: createMandatoryQuestions(
                job.mandatoryQuestions,
                {}),
            appliedAt: new Date(),
